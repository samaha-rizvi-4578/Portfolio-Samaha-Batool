      ...
      <div className='relative w-full md:w-3/5'>
        <a href={githubLink} target="_blank" rel="noopener noreferrer">
          <motion.img
            src={image}
            alt='project_image'
            className='w-full h-auto object-cover md:rounded-3xl transition-transform duration-300 ease-in-out'
            whileHover={{
              scale: 0.9,
              boxShadow: "0 0 15px rgba(255, 255, 255, 0.4), 0 0 30px rgba(255, 255, 255, 0.5), 0 0 45px rgba(255, 255, 255, 0.6), 0 0 60px rgba(255, 255, 255, 0.7), 0 0 75px rgba(255, 255, 255, 0.8)",
            }}
            transition={{
              duration: 0.3,
              ease: "easeInOut",
